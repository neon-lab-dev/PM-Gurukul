    ...
    return (
      <div className="flex flex-col gap-2 font-Inter w-full">
        ...
        <input
          ...
          ref={ref}
          disabled={isDisabled}
          className={`px-[18px] py-[14px] rounded-lg  border focus:outline-none focus:border-primary-10 transition duration-300 ${isDisabled ? "bg-neutral-10/30" : "bg-neutral-70"} ${error ? "border-red-500" : "border-neutral-75"
            }`}
          {...rest}
        />
        {error?.message && (
