  ...
  return (
    <div className="bg-neutral-80 h-screen flex items-center justify-center font-Inter p-5">
      <form
        ...
        className="bg-white border border-neutral-15 rounded-[20px] p-5 md:p-[60px] flex flex-col gap-5 h-[400px] md:h-[436px] w-[529px] max-auto"
      >
        ...
        <div className="flex items-center justify-center gap-2 mb-5">
          <p className="text-neutral-30 text-sm leading-5">
            OTP has been sent to <strong>+91 {otpData?.mobileNumber}</strong>
          </p>
          <Link to={"/auth/login"}>
        ...
        {isTimerFinished ? (
          <Link
            to={"/auth/signup"}
            className="text-primary-10 text-sm leading-5 font-medium text-center"
          >
            Resend OTP
          </Link>
        ) : (
